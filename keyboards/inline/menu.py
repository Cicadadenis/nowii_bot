    ...
    keyboard = InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                ...
                InlineKeyboardButton(text="📝 Список Users", callback_data="use"),
                InlineKeyboardButton(text="🗑Удалить фото", callback_data="fdel")
            ],

            [
                InlineKeyboardButton(text="⏱ Тайменг", callback_data="paussa"),
                InlineKeyboardButton(text="🧬 Снос крнтактов", callback_data="rep")
            ],
            #[
